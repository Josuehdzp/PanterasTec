...
public LinearLayout mContenedorHorario;
    ...
    //private DatabaseHelperBDhorario mDBHelper;
    SQLiteDatabase dby;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tect_content_horario);
...
////////
        ...
        //databaseHelperproto = new DatabaseHelperBDproto(this);
        //databaseHelperproto.StartWork();
...
/*
    private void usarDB (){
        File database = getApplicationContext().getDatabasePath(DatabaseHelperBDhorario.DBNOMBRE);
        if (!database.exists()){
            databaseHelperproto.getWritableDatabase();
            //copiar db
            if (copiarDatabase(this)){
                Toast.makeText(this, "Copiado correcto", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, "Copiado erroneo", Toast.LENGTH_SHORT).show();
                return;
            }
        }
    }
    ...
    private boolean copiarDatabase(Context context){
        try {
            ...
            InputStream inputStream = context.getAssets().open(DatabaseHelperBDhorario.DBNOMBRE);
            String outFileName = DatabaseHelperBDhorario.DBLOCACION+DatabaseHelperBDhorario.DBNOMBRE;
            ...
            outputStream.close();
            inputStream.close();
            Log.v("HorarioPersonalizado","DB copiada");
            return true;
        } catch (Exception e){
            e.printStackTrace();
            return false;
...
*/
    ...
    public void MostrarDBMartes() {
        ...
        try {
            ...
            if (mMarColor5!=null) {
                mMarColor5.setText(miCursorMartes.getString(30));
                linemartes5.setBackgroundColor(Color.parseColor(miCursorMartes.getString(30)));
            }
