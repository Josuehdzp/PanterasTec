...
public class MensajeriaActivityIFOR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = database.getReference(Constantes.NODO_MENSAJES_FORESTAL);//Sala de chat (nombre) version 2
                ...
                if(mapUsuariosTemporales.get(mensaje.getKeyEmisor())!=null){
                    ...
                    UsuarioDAO.getInstancia().obtenerInformacionDeUsuarioPorLLave(mensaje.getKeyEmisor(), new UsuarioDAO.IDevolverUsuario() {
                        ...
                        public void devolverError(String error) {
                            Toast.makeText(MensajeriaActivityIFOR.this, "Error: "+error, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == PHOTO_SEND && resultCode == RESULT_OK){
            Uri u = data.getData();
            storageReference = storage.getReference("imagenes_chat_"+Constantes.NODO_MENSAJES_FORESTAL);//imagenes_chat
        ...
        if(currentUser!=null){
            ...
            reference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (CARRERITAS.equals("IFOR")){

                        Snackbar.make(findViewById(R.id.linearMensajeria), "Hola, bienvenido al chat IFOR :D", Snackbar.LENGTH_LONG)
    ...
    private void returnLogin(){
        startActivity(new Intent(MensajeriaActivityIFOR.this, LoginActivity.class));
        finish();
    }
