...
public class FBTest extends AppCompatActivity implements View.OnClickListener {

    private String TAG = FBTest.class.getSimpleName();
...
//    }
    ...
    public class AsyncTaskExample extends AsyncTask<String, String, String[]> {
        ...
        protected void onPreExecute() {
            pDialog = new ProgressDialog(FBTest.this);
            pDialog.setIcon(R.mipmap.ic_launcher_round);
            pDialog.setTitle("Espera un poco");
            pDialog.setMessage("Estoy descargando noticias... :D");
            pDialog.show();
...
///////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            Glide.with(FBTest.this).load(stringFromDoInBackground[5]).into(FeedImagenext);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            Glide.with(FBTest.this).load(stringFromDoInBackground[12]).into(FeedImagenext);
            FeedImagenext.setVisibility(View.VISIBLE);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            Glide.with(FBTest.this).load(stringFromDoInBackground[19]).into(FeedImagenext);
            FeedImagenext.setVisibility(View.VISIBLE);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            Glide.with(FBTest.this).load(stringFromDoInBackground[26]).into(FeedImagenext);
            FeedImagenext.setVisibility(View.VISIBLE);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            Glide.with(FBTest.this).load(stringFromDoInBackground[33]).into(FeedImagenext);
            FeedImagenext.setVisibility(View.VISIBLE);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            Glide.with(FBTest.this).load(stringFromDoInBackground[40]).into(FeedImagenext);
            FeedImagenext.setVisibility(View.VISIBLE);
            ...
            Glide.with(FBTest.this).load(stringFromDoInBackground[47]).into(FeedImagenext);
            FeedImagenext.setVisibility(View.VISIBLE);
            ...
            Glide.with(FBTest.this).load(stringFromDoInBackground[54]).into(FeedImagenext);
            FeedImagenext.setVisibility(View.VISIBLE);
            ...
            Glide.with(FBTest.this).load(stringFromDoInBackground[61]).into(FeedImagenext);
            FeedImagenext.setVisibility(View.VISIBLE);
            ...
            Glide.with(FBTest.this).load(stringFromDoInBackground[68]).into(FeedImagenext);
            FeedImagenext.setVisibility(View.VISIBLE);
    ...
    public void onClick(View v) {
        Intent miIntent = new Intent(FBTest.this, MainFacebookJsonParseNext1.class);
