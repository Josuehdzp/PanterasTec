...
public class FeedFacebookAdapterTest extends RecyclerView.Adapter<FeedFacebookAdapterTest.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.cardFeedPrincipal.setAnimation(AnimationUtils.loadAnimation(context,R.anim.fade_scale_animation));
        holder.tv_full_picture.setAnimation(AnimationUtils.loadAnimation(context,R.anim.fade_transition_animation));
        ...
        if (feedItem.getFull_picture()!=null){
            ...
            Picasso.with(holder.getTv_full_picture().getContext())
...
*/
    ...
    public class ViewHolder extends RecyclerView.ViewHolder  {
        ...
        public CardView cardFeedPrincipal;
        ...
        public ViewHolder(View itemView) {
            ...
            cardFeedPrincipal.setCardBackgroundColor(itemView.getResources().getColor(R.color.trans));
