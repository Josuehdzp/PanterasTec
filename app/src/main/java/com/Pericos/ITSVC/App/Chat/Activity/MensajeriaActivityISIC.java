...
public class MensajeriaActivityISIC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagePicker.setImagePickerCallback(new ImagePickerCallback() {
            ...
            public void onError(String s) {
                Toast.makeText(MensajeriaActivityISIC.this, "Error: "+s, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        fotoPerfil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(MensajeriaActivityISIC.this);
                ...
                if(mapUsuariosTemporales.get(mensaje.getKeyEmisor())!=null){
                    ...
                    UsuarioDAO.getInstancia().obtenerInformacionDeUsuarioPorLLave(mensaje.getKeyEmisor(), new UsuarioDAO.IDevolverUsuario() {
                        ...
                        public void devolverError(String error) {
                            Toast.makeText(MensajeriaActivityISIC.this, "Error: "+error, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            ...
            reference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (CARRERITAS.equals("ISIC")){
                        ...
                        CafeBar.builder(MensajeriaActivityISIC.this)
                                .icon(R.drawable.icono_escencial_usuario)
                                .maxLines(1)
                                .content("Hola, bienvenido al chat para ISIC :D")
                                .neutralText("Di hola")
                        ...
                        /*Snackbar.make(findViewById(R.id.linearMensajeria), "Hola, bienvenido al chat para ISIC :D", Snackbar.LENGTH_LONG)
...
*/
    ...
    private void returnLogin(){
        startActivity(new Intent(MensajeriaActivityISIC.this, LoginActivity.class));
        finish();
    }
