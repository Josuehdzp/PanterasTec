...
public class MensajeriaAdaptador extends RecyclerView.Adapter<MensajeriaHolder> {
    ...
    public MensajeriaHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view;
        if(viewType==1){
            view = LayoutInflater.from(c).inflate(R.layout.chat_cardview_mensajes_emisor,parent,false);
        }else{
            view = LayoutInflater.from(c).inflate(R.layout.chat_cardview_mensajes_receptor,parent,false);
        }
